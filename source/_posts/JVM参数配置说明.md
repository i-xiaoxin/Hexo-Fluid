---
title: JVM参数配置说明
date: 2023-03-11 21:09:02
tags: 
- Java
- JVM
index_img: 
banner_img: /img/article5.webp
categories:
- Java
comment: waline
---
...
<p style="text-align:center;color:green">堆栈大小典型配置参数</p>
...
<p style="text-align:center;color:green">吞吐量优先的GC典型配置参数</p>
...
<p style="text-align:center;color:green">响应时间优先的GC典型配置参数</p>
...
<p style="text-align:center;color:green">用于辅助的GC典型配置参数</p>

[原文链接🔗](https://help.aliyun.com/document_detail/148851.html)

推荐阅读：

[JVM内存配置最佳实践](https://help.aliyun.com/document_detail/383255.html)

[设置Java应用的启动加速](https://help.aliyun.com/document_detail/193456.html)

[为Spring Boot应用设置健康检查](https://help.aliyun.com/document_detail/200637.html)
